  ...
  return (
    <div className="min-h-screen bg-white pt-20 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="card-white overflow-hidden">
              ...
              <div className="on-ink relative bg-ink px-8 py-7 overflow-hidden">
                ...
                <div className="relative flex items-center gap-5">
                  ...
                  <div>
                    <div className="text-lime-light text-xs font-bold uppercase tracking-wider mb-1 capitalize">{product.category.replace(/-/g, ' ')}</div>
              ...
              <div className="p-8">
                <div className="flex flex-wrap items-center gap-2.5 mb-4">
                  ...
                  <span className="px-3 py-1 rounded-full bg-surface border border-line text-ink-soft text-xs font-mono">CAS {product.cas}</span>
                  {product.featured && (
          ...
          <div className="space-y-5">
            ...
            <div className="on-ink rounded-2xl bg-ink p-5 text-center relative overflow-hidden">
              ...
              <div className="relative">
                <div className="inline-flex items-center gap-1.5 text-lime-light text-[11px] font-bold uppercase tracking-wider mb-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-lime-light animate-pulse" /> Live Pricing
                </div>
            ...
            <div className="card-white p-6 border-2 border-lime/30">
              ...
              <p className="text-ink-soft text-xs mb-5">Full CIF quote with COA &amp; documentation in 48 hours</p>
        ...
        {related.length > 0 && (
          <div className="mt-16">
            <h2 className="font-jakarta text-2xl font-extrabold text-ink mb-6">Related Products</h2>
              ...
              {related.map(p => (
                <Link key={p.id} href={`/products/${p.id}`} className="card-white p-5 flex items-center gap-4 group">
                  ...
                  <div className="min-w-0">
                    <div className="font-jakarta font-bold text-ink group-hover:text-lime-text transition-colors leading-snug">{p.name}</div>
                    <div className="text-ink-subtle text-xs mt-0.5 truncate">{p.grade}</div>
                  </div>
                </Link>
              ))}
            </div>
